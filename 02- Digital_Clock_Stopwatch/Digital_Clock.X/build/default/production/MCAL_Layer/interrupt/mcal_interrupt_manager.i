...
# 109 "MCAL_Layer/interrupt/mcal_interrupt_manager.c"
void __attribute__((picinterrupt(("")))) InterruptManager(void)
{

    if((1U==INTCONbits.INT0E) && (1U==INTCONbits.INT0F))
    {
        INT0_ISR();
    }
    if((1U==INTCON3bits.INT1E) && (1U==INTCON3bits.INT1F))
    {
        INT1_ISR();
    }
    if((1U==INTCON3bits.INT2E) && (1U==INTCON3bits.INT2F))
    {
        INT2_ISR();
    }
    ...
    if ((1U == INTCONbits.RBIE) && (1U == INTCONbits.RBIF)
    ...
    if((1U == PIE1bits.TMR1IE) && (1U == PIR1bits.TMR1IF))
    {
        TMR1_ISR();
    }
    ...
    if((1U == PIE2bits.TMR3IE) && (1U == PIR2bits.TMR3IF))
    {
        TMR3_ISR();
    }
