...
# 1 "MCAL_Layer/interrupt/../Limits.h" 1
...
# 81 "MCAL_Layer/interrupt/../GPIO/hal_gpio.h"
...
# 1 "MCAL_Layer/interrupt/macl_interrupt_gen_cfg.h" 1
...
static void (*RB4_InterruptHandler)(uint8) = ((void*)0);
static void (*RB5_InterruptHandler)(uint8) = ((void*)0);
static void (*RB6_InterruptHandler)(uint8) = ((void*)0);
static void (*RB7_InterruptHandler)(uint8) = ((void*)0);
...
void INT_RB4_ISR(uint8 pin_status)
{
    ...
    if (((void*)0) != RB4_InterruptHandler) {
...
void INT_RB5_ISR(uint8 pin_status)
{
    ...
    if (((void*)0) != RB5_InterruptHandler) {
...
void INT_RB6_ISR(uint8 pin_status)
{
    ...
    if (((void*)0) != RB6_InterruptHandler) {
...
void INT_RB7_ISR(uint8 pin_status)
{
    ...
    if (((void*)0) != RB7_InterruptHandler) {
...
# 313 "MCAL_Layer/interrupt/mcal_external_interrupt.c"
static Std_ReturnType Interrupt_INTx_Edge_init(const interrupt_INTx_t* int_obj) {
    Std_ReturnType ret = (Std_ReturnType)0x00;
    if (((void*)0) == int_obj) {
        ret = (Std_ReturnType)0x00;
