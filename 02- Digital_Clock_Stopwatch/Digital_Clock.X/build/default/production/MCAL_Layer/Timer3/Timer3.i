...
# 12 "MCAL_Layer/Timer3/../interrupt/../compiler.h"
...
# 12 "MCAL_Layer/Timer3/../interrupt/../compiler.h" 2
...
# 1 "MCAL_Layer/Timer3/../interrupt/../Limits.h" 1
...
# 1 "MCAL_Layer/Timer3/../interrupt/../device_config.h" 1
...
# 36 "MCAL_Layer/Timer3/../interrupt/../GPIO/hal_gpio.h"
typedef enum {
    GPIO_LOW = 0,
    GPIO_HIGH = 1
}logic_t;
...
# 81 "MCAL_Layer/Timer3/../interrupt/../GPIO/hal_gpio.h"
...
# 1 "MCAL_Layer/Timer3/../interrupt/macl_interrupt_gen_cfg.h" 1
# 17 "MCAL_Layer/Timer3/../interrupt/mcal_interrupt_config.h" 2
# 12 "MCAL_Layer/Timer3/../interrupt/mcal_internal_interrupt.h" 2

# 1 "MCAL_Layer/Timer3/../interrupt/mcal_interrupt_manager.h" 1
# 21 "MCAL_Layer/Timer3/../interrupt/mcal_interrupt_manager.h"
...
static __attribute__((inline)) void timer3_mode_select(const timer3_config_t* _timer3);
static __attribute__((inline)) void timer3_RW_reg_size_select(const timer3_config_t* _timer3);
...
# 52 "MCAL_Layer/Timer3/Timer3.c"
        ...
        (T3CONbits.T3CKPS = (_timer3->timer3_prescaler_value));
...
Std_ReturnType Timer3_read_value(const timer3_config_t* _timer3, uint16 *_value)
{
    uint8 l_tmr3l = 0U, l_tmr3h = 0U;
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(_timer3 == ((void*)0) || _value == ((void*)0))
    {
        ret = (Std_ReturnType)0x00;
    }
    else
...
static __attribute__((inline)) void timer3_mode_select(const timer3_config_t* _timer3)
{
    ...
    if(_timer3->timer3_mode == 1)
    {
        (T3CONbits.TMR3CS = 1);

        if(_timer3->timer3_counter_sync == 0)
        {
            (T3CONbits.T3SYNC = 1);
        }
        else if(_timer3->timer3_counter_sync == 1)
        {
            (T3CONbits.T3SYNC = 0);
        }
    }
    else if(_timer3->timer3_mode == 0)
    {
        (T3CONbits.TMR3CS = 0);
    }
}
