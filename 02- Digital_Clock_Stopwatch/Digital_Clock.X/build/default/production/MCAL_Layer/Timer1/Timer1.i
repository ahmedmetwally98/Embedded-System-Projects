...
# 12 "MCAL_Layer/Timer1/../interrupt/../compiler.h"
...
# 12 "MCAL_Layer/Timer1/../interrupt/../compiler.h" 2
...
# 1 "MCAL_Layer/Timer1/../interrupt/../Limits.h" 1
...
# 1 "MCAL_Layer/Timer1/../interrupt/../device_config.h" 1
...
# 36 "MCAL_Layer/Timer1/../interrupt/../GPIO/hal_gpio.h"
typedef enum {
    GPIO_LOW = 0,
    GPIO_HIGH = 1
}logic_t;
...
# 81 "MCAL_Layer/Timer1/../interrupt/../GPIO/hal_gpio.h"
...
# 1 "MCAL_Layer/Timer1/../interrupt/macl_interrupt_gen_cfg.h" 1
# 17 "MCAL_Layer/Timer1/../interrupt/mcal_interrupt_config.h" 2
# 12 "MCAL_Layer/Timer1/../interrupt/mcal_internal_interrupt.h" 2

# 1 "MCAL_Layer/Timer1/../interrupt/mcal_interrupt_manager.h" 1
# 21 "MCAL_Layer/Timer1/../interrupt/mcal_interrupt_manager.h"
...
void TMR1_ISR(void);
# 9 "MCAL_Layer/Timer1/Timer1.c" 2
...
static __attribute__((inline)) void timer1_mode_select(const timer1_config_t* _timer1);
static __attribute__((inline)) void timer1_RW_reg_size_select(const timer1_config_t* _timer1);
...
# 52 "MCAL_Layer/Timer1/Timer1.c"
        ...
        if(_timer1->timer1_oscillator==1)
        {
            (T1CONbits.T1OSCEN = 1);
        }
        else
...
Std_ReturnType Timer1_read_value(const timer1_config_t* _timer1, uint16 *_value)
{
    uint8 l_tmr1l = 0U, l_tmr1h = 0U;
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(_timer1 == ((void*)0) || _value == ((void*)0))
    {
        ret = (Std_ReturnType)0x00;
    }
    else
...
static __attribute__((inline)) void timer1_mode_select(const timer1_config_t* _timer1)
{
    ...
    if(_timer1->timer1_mode == 1)
    {
        (T1CONbits.TMR1CS = 1);


        if(_timer1->timer1_counter_sync == 0)
        {
            (T1CONbits.T1SYNC = 1);
        }
        else if(_timer1->timer1_counter_sync == 1)
        {
            (T1CONbits.T1SYNC = 0);
        }
    }
    else if(_timer1->timer1_mode == 0)
    {
        (T1CONbits.TMR1CS = 0);
    }
}
