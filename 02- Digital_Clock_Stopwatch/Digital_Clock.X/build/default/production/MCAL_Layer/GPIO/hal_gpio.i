...
Std_ReturnType GPIO_pin_direction_initialize(const pin_config_t *_pin_config_ptr)
{
    ...
    if (((void*)0) == _pin_config_ptr || _pin_config_ptr->pin > 8 -1
            || _pin_config_ptr->port > 5 -1)
    {
    ...
    else
    {
        switch(_pin_config_ptr->direction)
        {
            case GPIO_DIRECTION_OUTPUT :
                (((*TRIS_Registers[_pin_config_ptr->port]) &= ~((uint8)1<<(_pin_config_ptr->pin))));
                break;
...
# 62 "MCAL_Layer/GPIO/hal_gpio.c"
Std_ReturnType GPIO_pin_get_direction_status(const pin_config_t *_pin_config_ptr, direction_t *direction_status_ptr)
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if (((void*)0) == _pin_config_ptr || ((void*)0) == direction_status_ptr || _pin_config_ptr->pin > 8 -1
            || _pin_config_ptr->port > 5 -1)
    {
        ret = (Std_ReturnType)0x00;
    }
    ...
    {
        *direction_status_ptr = ((*TRIS_Registers[_pin_config_ptr->port]) >> (_pin_config_ptr->pin) & ((uint8)1));
    }
    return ret;
}
# 87 "MCAL_Layer/GPIO/hal_gpio.c"
Std_ReturnType GPIO_pin_read_logic (const pin_config_t *_pin_config_ptr, logic_t *log_value_ptr)
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if (((void*)0) == _pin_config_ptr || ((void*)0) == log_value_ptr || _pin_config_ptr->pin > 8 -1
            || _pin_config_ptr->port > 5 -1)
    {
        ret = (Std_ReturnType)0x00;
    }
    ...
    {
        *log_value_ptr = ((*PORT_Registers[_pin_config_ptr->port]) >> (_pin_config_ptr->pin) & ((uint8)1));
    }
    return ret;
}
...
Std_ReturnType GPIO_pin_write_logic (const pin_config_t * _pin_config_ptr, logic_t _logic)
{
    ...
    else
    {
        ...
        else
        {
            ...
            {
                case GPIO_LOW :
                    (((*LAT_Registers[_pin_config_ptr->port]) &= ~((uint8)1<<(_pin_config_ptr->pin))));
                    break;
                case GPIO_HIGH :
                    (((*LAT_Registers[_pin_config_ptr->port]) |= ((uint8)1<<(_pin_config_ptr->pin))));
                    break;
...
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if (((void*)0) == _pin_config_ptr || _pin_config_ptr->port > 5 -1
            || _pin_config_ptr->pin > 8 -1)
    {
        ret = (Std_ReturnType)0x00;
    }
    else
...
# 258 "MCAL_Layer/GPIO/hal_gpio.c"
Std_ReturnType GPIO_port_get_direction_status(port_index_t _port, uint8 *direction_status)
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if (((void*)0) == direction_status || _port > 5 -1)
    {
        ret = (Std_ReturnType)0x00;
    }
    else
...
# 306 "MCAL_Layer/GPIO/hal_gpio.c"
Std_ReturnType GPIO_port_read_logic (port_index_t _port, uint8 *port_logic_ptr)
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if (((void*)0) == port_logic_ptr || _port > 5 -1)
    {
        ret = (Std_ReturnType)0x00;
    }
    else
...
# 330 "MCAL_Layer/GPIO/hal_gpio.c"
Std_ReturnType GPIO_port_toggle(port_index_t _port)
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if (_port > 5 -1)
