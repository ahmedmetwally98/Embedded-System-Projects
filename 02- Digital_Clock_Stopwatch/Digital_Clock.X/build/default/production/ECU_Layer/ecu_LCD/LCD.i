...
# 1 "ECU_Layer/ecu_LCD/LCD.h" 1
# 12 "ECU_Layer/ecu_LCD/LCD.h"
...
# 1 "ECU_Layer/ecu_LCD/../../MCAL_Layer/GPIO/../Limits.h" 1
# 14 "ECU_Layer/ecu_LCD/../../MCAL_Layer/GPIO/../mcal_std_types.h" 2
...
# 16 "ECU_Layer/ecu_LCD/../../MCAL_Layer/GPIO/hal_gpio.h" 2
# 36 "ECU_Layer/ecu_LCD/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef enum {
    GPIO_LOW = 0,
    GPIO_HIGH = 1
}logic_t;
...
# 81 "ECU_Layer/ecu_LCD/../../MCAL_Layer/GPIO/hal_gpio.h"
...
# 12 "ECU_Layer/ecu_LCD/LCD.h" 2
# 56 "ECU_Layer/ecu_LCD/LCD.h"
typedef struct {
    pin_config_t RS_pin;
    pin_config_t E_pin;
...
static void* memset(void* str, uint8 ch, uint8 str_size);
...
Std_ReturnType lcd_4bit_initialize(const char_lcd_t* lcd_obj)
{
   Std_ReturnType ret = (Std_ReturnType)0x00;
    ...
    else
    {
        ...
        ret = lcd_send_4bit(lcd_obj, 0x02);
        ret = lcd_4bit_send_command(lcd_obj, 0x08);
...
Std_ReturnType lcd_4bit_send_command(const char_lcd_t* lcd_obj, uint8 lcd_command)
{
    ...
    else
    {
        ...
        ret = lcd_send_4bit(lcd_obj, (lcd_command >> 4));
        ret = lcd_send_enable_signal(lcd_obj);
        ret = lcd_send_4bit(lcd_obj, lcd_command);
        ret = lcd_send_enable_signal(lcd_obj);
    }
...
Std_ReturnType lcd_4bit_send_char_data(const char_lcd_t* lcd_obj, uint8 lcd_data)
{
    ...
    else
    {
        ...
        ret = lcd_send_4bit(lcd_obj, (lcd_data >> 4));
        ret = lcd_send_enable_signal(lcd_obj);
        ret = lcd_send_4bit(lcd_obj, lcd_data);
        ret = lcd_send_enable_signal(lcd_obj);
    }
    return ret;
}
...
static Std_ReturnType lcd_4bit_set_cursor_pos(const char_lcd_t* lcd_obj, uint8 row, uint8 col)
{
    ...
    {
        case 0x01:
            ret = lcd_4bit_send_command(lcd_obj, 0x80 + row1_offset + col);
            break;
        case 0x02:
            ret = lcd_4bit_send_command(lcd_obj, 0x80 + row2_offset + col);
            break;
        case 0x03:
            ret = lcd_4bit_send_command(lcd_obj, 0x80 + row3_offset + col);
            break;
        case 0x04:
            ret = lcd_4bit_send_command(lcd_obj, 0x80 + row4_offset + col);
            break;
        default:
            break;
    }
...
static Std_ReturnType lcd_send_4bit(const char_lcd_t* lcd_obj, uint8 _data_command)
{
    ...
    for (l_pin_counter = 0; l_pin_counter < 4; l_pin_counter++)
    {
        ret = GPIO_pin_write_logic(&(lcd_obj->lcd_data_pins[l_pin_counter]), ((_data_command >> l_pin_counter) & (uint8)1));
    }
    return ret;
}
