# 1 "ECU_Layer/7Seg/ecu_7segment.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "ECU_Layer/7Seg/ecu_7segment.c" 2
...
# 1 "ECU_Layer/7Seg/ecu_7segment.h" 1
# 12 "ECU_Layer/7Seg/ecu_7segment.h"
# 1 "ECU_Layer/7Seg/../../MCAL_Layer/GPIO/hal_gpio.h" 1
# 13 "ECU_Layer/7Seg/../../MCAL_Layer/GPIO/hal_gpio.h"
# 1 "ECU_Layer/7Seg/../../MCAL_Layer/GPIO/../mcal_std_types.h" 1
# 12 "ECU_Layer/7Seg/../../MCAL_Layer/GPIO/../mcal_std_types.h"
# 1 "ECU_Layer/7Seg/../../MCAL_Layer/GPIO/../compiler.h" 1
# 12 "ECU_Layer/7Seg/../../MCAL_Layer/GPIO/../compiler.h"
...
# 12 "ECU_Layer/7Seg/../../MCAL_Layer/GPIO/../compiler.h" 2
# 12 "ECU_Layer/7Seg/../../MCAL_Layer/GPIO/../mcal_std_types.h" 2

# 1 "ECU_Layer/7Seg/../../MCAL_Layer/GPIO/../std_libraries.h" 1
# 13 "ECU_Layer/7Seg/../../MCAL_Layer/GPIO/../mcal_std_types.h" 2

# 1 "ECU_Layer/7Seg/../../MCAL_Layer/GPIO/../Limits.h" 1
# 14 "ECU_Layer/7Seg/../../MCAL_Layer/GPIO/../mcal_std_types.h" 2
...
# 13 "ECU_Layer/7Seg/../../MCAL_Layer/GPIO/hal_gpio.h" 2

# 1 "ECU_Layer/7Seg/../../MCAL_Layer/GPIO/../device_config.h" 1
# 14 "ECU_Layer/7Seg/../../MCAL_Layer/GPIO/hal_gpio.h" 2


# 1 "ECU_Layer/7Seg/../../MCAL_Layer/GPIO/hal_gpio_cfg.h" 1
# 16 "ECU_Layer/7Seg/../../MCAL_Layer/GPIO/hal_gpio.h" 2
# 36 "ECU_Layer/7Seg/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef enum {
    GPIO_LOW = 0,
    GPIO_HIGH = 1
}logic_t;
...
# 81 "ECU_Layer/7Seg/../../MCAL_Layer/GPIO/hal_gpio.h"
...
# 12 "ECU_Layer/7Seg/ecu_7segment.h" 2

# 1 "ECU_Layer/7Seg/ecu_7segment_cfg.h" 1
# 13 "ECU_Layer/7Seg/ecu_7segment.h" 2
# 24 "ECU_Layer/7Seg/ecu_7segment.h"
typedef enum
{
...
# 8 "ECU_Layer/7Seg/ecu_7segment.c" 2
...
Std_ReturnType seven_segment_initialize(const segment_t *segment_ptr)
{
    ...
    if (((void*)0) == segment_ptr)
    {
        ret = (Std_ReturnType)0x00;
    }
    else
    {
        ret = GPIO_pin_initialize(&(segment_ptr->segment_pins[(uint8)0]));
        ret = GPIO_pin_initialize(&(segment_ptr->segment_pins[(uint8)1]));
        ret = GPIO_pin_initialize(&(segment_ptr->segment_pins[(uint8)2]));
        ret = GPIO_pin_initialize(&(segment_ptr->segment_pins[(uint8)3]));
    }
    return ret;
}
...
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if ((((void*)0) == segment_ptr) || (number > (uint8)9) || (number < (uint8)0))
    {
        ret = (Std_ReturnType)0x00;
    }
    else
    {
        uint8 value = 0x00;
        value = ((number >> (uint8)0) & (uint8)1);
        ret = GPIO_pin_write_logic(&(segment_ptr->segment_pins[(uint8)0]), value);
        value = ((number >> (uint8)1) & (uint8)1);
        ret = GPIO_pin_write_logic(&(segment_ptr->segment_pins[(uint8)1]), value);
        value = ((number >> (uint8)2) & (uint8)1);
        ret = GPIO_pin_write_logic(&(segment_ptr->segment_pins[(uint8)2]), value);
        value = ((number >> (uint8)3) & (uint8)1);
        ret = GPIO_pin_write_logic(&(segment_ptr->segment_pins[(uint8)3]), value);
    }
    return ret;
}
